...
var defaultConfig = {
  ...
  FileTypesPath: {
    ...
    File: mainConfig.user_file_path + '/',
    Image: mainConfig.user_file_path + '/',
    Flash: mainConfig.user_file_path + '/',
    Media: mainConfig.user_file_path + '/',
  },
  FileTypesAbsolutePath:{
    ...
    File: mainConfig.user_file_abs_path == '' ? '' : mainConfig.user_file_abs_path +'/',
    Image: mainConfig.user_file_abs_path == '' ? '' : mainConfig.user_file_abs_path + '/',
    Flash: mainConfig.user_file_abs_path == '' ? '' : mainConfig.user_file_abs_path + '/',
    Media: mainConfig.user_file_abs_path == '' ? '' : mainConfig.user_file_abs_path + '/',
  },
  QuickUploadPath: {
    File: mainConfig.user_file_path + '/',
    Image: mainConfig.user_file_path + '/',
